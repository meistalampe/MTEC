...
featuring more subjects, for ml purposes but also with more refined emotion elictitation paradigm, better subject selection
\textbf{Deploy artifact compensation based on acceleration data.}
acceleration data. Artifact filtering was handled rather primitive. Investigate strategies to adapt signal analysis or detection based on acceleration data derived from the empatica wristband.
...
\textbf{Linear fusion of simple classifier}
To our surprise single signal feature sets such as GSR and Temp performed well on some of the classification tasks. Inspired by the work of Wei et al. (2018) we propose the investigation of the effects of Weighted Fusion Strategy.
